...
<div class="rounded-lg shadow-md bg-white p-4">
    ...
    <a href="{{ route('jobs.show', $job) }}"
        class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium  bg-green-500 text-white hover:bg-green-600 transition-colors">
        Details
    </a>
</div>
