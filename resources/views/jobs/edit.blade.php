<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job) }}" enctype="multipart/form-data">
            ...
            <x-inputs.select id="remote" name="remote" label="Remote" :options="[false => 'No', true => 'Yes']" :value="old('remote', $job->remote)" />
            ...
            <x-inputs.text-area id="company_description" name="company_description" label="Company Description"
                placeholder="We are seeking a skilled and motivated Software Developer to join our growing development team..." :value="old('company_description', $job->company_description)" />
